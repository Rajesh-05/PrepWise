      ...
      <div className="question-bank-container">
        ...
        <div className="question-filters-container">
          ...
          <div className="filters-footer">
            <button className="refresh-button" onClick={fetchQuestions}>Refresh</button>
            <button className="submit-button" onClick={fetchQuestions}>Generate</button>
          </div>
        </div>
        ...
        <div className="question-results-container">
          {loading && (
            <div className="qb-loading">
              ...
              <p className="qb-loading-text">Generating questions...</p>
            </div>
          )}
          ...
          {!loading && !error && questions.length === 0 && (
            <div className="qb-empty-state">
              ...
              <p>Use the filters and click <strong>Generate</strong> to get tailored questions.</p>
              <div className="qb-empty-tip">
                💡 Tip: Add a company name for highly targeted questions
              </div>
            </div>
          )}
